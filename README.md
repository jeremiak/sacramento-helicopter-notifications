# Sacramento police helicopter notifcations

A machine readable dataset scraped from the [Sacramento police helipcopter notifications page](https://www.cityofsacramento.org/Police/News-Alerts/Helicopter-Notifications).
